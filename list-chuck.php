 ...
 *
 * @wordpress-plugin
 * Plugin Name:       LIST CHUCK
 * Plugin URI:        http://Ponchodev/
 * Description:       Esta es una versión de prueba para obtener 15 jokes.
 * Version:           1.0.0
 * Author:            PonchoDev
 * Author URI:        PonchoDev
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Text Domain:       list-chuck
 */
...
<?php
	...
	return $contentResult; //Retornamos lo obtnido

}


//Esta función crea un campo personalizado con el valor del shortcode
//Yse adiciona como valor a nuestra API de woocomerce
